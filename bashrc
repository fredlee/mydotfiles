...
# PATH
export PATH=/opt/ruby-enterprise-1.8.7-2009.10/bin:~/.gem/ruby/1.8/bin:/opt/local/bin:/opt/local/sbin:/opt/mongodb-osx-x86_64-1.2.1/bin/:/usr/local/mysql/bin:$PATH
